...
final class AdminAnswerController extends AbstractController
{
    ...
    {
        return $this->render('adminanswer/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('adminanswer/new.html.twig', [
            'answer' => $answer,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('adminanswer/show.html.twig', [
            'answer' => $answer,
        ]);
    }
    ...
    public function edit(Request $request, Answer $answer, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('adminanswer/edit.html.twig', [
            'answer' => $answer,
            'form' => $form,
        ]);
    }
